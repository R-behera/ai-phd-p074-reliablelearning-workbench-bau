...
METHOD_SPEC = {
    "algorithm_id": "P074-Bau-DeepLearningInterpretability",
    "algorithm_name": "BauTriangulatedDeepLearningInterpretabilityProbeMatrix",
    "project_family": "ml",
    "professor": "David Bau",
    "focus": "Deep learning interpretability",
    "core_mechanism": "prioritizes decision-support failures with calibration and subgroup reliability risk",
    "decision_rule": "Rank seed cases by ml-specific priority score with Bau-aligned focus term 'Deep learning interpretability'.",
